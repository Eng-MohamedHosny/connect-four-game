...
export const BottomShelf: React.FC<BottomShelfProps> = ({ gameStatus, winInfo }) => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 w-full h-[180px] sm:h-[200px] lg:h-[200px] ${bgColor} rounded-t-[60px] transition-colors duration-500 z-0 pointer-events-none`}
      aria-hidden="true"
    />
  );
};
